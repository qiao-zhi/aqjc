...
function btnLoadImagesOrPDFs_onclick() {
    ...
    if (Dynamsoft.Lib.env.bMac)
        DWObject.Addon.PDF.Download(strhttp + "//demo.dynamsoft.com/DWT/Resources/addon/MacPdf.zip", funLoadImagesOrPDFs, OnFailure);
    else if (Dynamsoft.Lib.env.bLinux)
        DWObject.Addon.PDF.Download(strhttp + "//demo.dynamsoft.com/DWT/Resources/addon/LinuxPdf.zip", funLoadImagesOrPDFs, OnFailure);
    else
        DWObject.Addon.PDF.Download(strhttp + "//demo.dynamsoft.com/DWT/Resources/addon/Pdf.zip", funLoadImagesOrPDFs, OnFailure);
}
...
function btnLoadPDF_onclick() {     
    ...
    if (Dynamsoft.Lib.env.bMac)
        DWObject.Addon.PDF.Download(strhttp + "//demo.dynamsoft.com/DWT/Resources/addon/MacPdf.zip", OnSuccess, OnFailure);
    else if (Dynamsoft.Lib.env.bLinux)
        DWObject.Addon.PDF.Download(strhttp + "//demo.dynamsoft.com/DWT/Resources/addon/LinuxPdf.zip", OnSuccess, OnFailure);
    else
        DWObject.Addon.PDF.Download(strhttp + "//demo.dynamsoft.com/DWT/Resources/addon/Pdf.zip", OnSuccess, OnFailure); 
}
...
function btnSave_onclick() {
    ...
    DWObject.IfShowFileDialog = true;
    var _txtFileNameforSave = document.getElementById("txt_fileName1");
    ...
    if (strimgType_save == "tif" && _chkMultiPageTIFF_save && _chkMultiPageTIFF_save.checked) {
        ...
        switch (i) {          
            case 0: bSave = DWObject.SaveAsPDF(strFilePath, DWObject.CurrentImageIndexInBuffer); break;
        }
    }
...
function btnUpload_onclick() {
    ...
    var _txtFileName = document.getElementById("txt_fileName1");
    if(_txtFileName)
    ...
    //strActionPage = CurrentPath + "uploadFileServlet"; 
    strActionPage = CurrentPath + "enApplyInfo_uploadScanFile.do"; 
    var redirectURLifOK = "enApplyInfo_add.jsp";
    for (i = 0; i < 5; i++) {
   ...
   /* if (strImageType == 2 && document.getElementById("MultiPageTIFF").checked) {
    ...
    if (strImageType == 1 && document.getElementById("MultiPagePDF").checked) {
    if ((DWObject.SelectedImagesCount == 1) || (DWObject.SelectedImagesCount == DWObject.HowManyImagesInBuffer)) {
