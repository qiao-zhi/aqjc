...
<script>
	...
	function showAuditInfo(){
		$.ajax({
			url : '${pageContext.request.contextPath}/pbsApply_selAuditInfo.do',
			data : {'appId' : '<%= applyId%>'},
			type : 'POST',
			dataType : 'json',
			success : function(response) {
...
<div style="padding: 10px">
	<div id="showInfoDiv" style="border:1px solid #999;width:100%;padding-top:20px;padding-bottom:50px;">
		<table align="center" class="infoTab" style="padding-bottom:50px;">
			...
			<tr>
				<td colspan="2" style="text-align:left;font-size:12px;padding-top:10px;">
					...
					<a href="javascript:void(0)" onclick="showInfo(6)">审核意见</a> 
				</td>
			</tr>
		</table>
		<div id="infoDiv1" >
		...
		<div id="infoDiv6" style="display: none">
		<form id=auditInfoFm" >
			<table align="center" class="infoTab">
				<tr>
					<th colspan="4" align="center" style="font-size:13px;padding-bottom:20px;">审核意见</th>
				</tr>
				<tr>
					<td class="lable-td">审核人：</td>
					<td class="input-td">
						<input id="auditUser" readonly="readonly"/>
					</td>
					<td class="lable-td" style="width:200px;">审核时间：</td>
					<td class="input-td">
						<input id="auditDate" readonly="readonly"/>
					</td>
				</tr>
				<tr>
					<td class="lable-td" >审核意见：</td>
					<td class="input-td" colspan="3">
						<textarea id="auditOpinion" name="auditOpinion" style="width:640px;height:150px;" readonly="readonly">
						</textarea>
					</td>
				</tr>
				<tr>
					<td class="lable-td" >审核结果：</td>
					<td colspan="3" style="padding-left:10px;padding-top:5px;padding-bottom:5px;font-size:25px;font-family:黑体;">
						<span id="auditRes"></span>
					</td>
				</tr>
			</table>
		</form>	
