...
<div style="padding: 10px">
	<div id="showInfoDiv" style="border:1px solid #999;width:100%;padding-top:20px;padding-bottom:50px;">
		...
		<form id="appInfoFm" action="<%=request.getContextPath() %>/pbsApply_addApply.do" method="post">
			<table align="center" class="infoTab">
				<tr>
				...
				<tr>
					...
					<td class="input-td" >
						...
						<input type="hidden" name="pbsTestApply.pbsBuilderId" value="<%= pbsBuilderId%>"/>
						<input type="hidden" name="pbsTestApply.pbsId" value="<%=pbsId %>"/>
