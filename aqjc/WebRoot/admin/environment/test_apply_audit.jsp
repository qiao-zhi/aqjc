...
<script>
	...
	function auditApply(auditRes){
		$.ajax({
			url : '${pageContext.request.contextPath}/pbsApply_auditApply.do?applyId=<%= applyId%>',
		...
		<form id=auditInfoFm" >
			<table align="center" class="infoTab">
				...
				<tr>
					...
					<td class="input-td" colspan="3">
						<textarea id="auditOpinion" name="auditOpinion" style="width:640px;height:150px;"></textarea>
						<input type="hidden" id="operate" name="operate" />
					</td>
				</tr>
				<tr>
					<td colspan="4" style="padding-top:20px;text-align:center;">
						<input type="button" value="审核通过 " onclick="auditApply(1)" style="width:80px;height:40px;"/> 
						<input type="button" value="审核不通过 " onclick="auditApply(0)" style="width:80px;height:40px;"/>
					</td>
				</tr>
			</table>
		</form>	
