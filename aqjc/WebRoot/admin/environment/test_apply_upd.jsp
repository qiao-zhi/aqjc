...
<script>
	...
	function showAppInfo(){
		$.ajax({
			...
			success : function(response) {
				var info = eval(response);
				$("#applyTestType").val(info.ApplyTestType);
				$("#applyTestGrade").val(info.ApplyTestGrade);
			}
		});
	}
...
<div style="padding: 10px">
	<div id="showInfoDiv" style="border:1px solid #999;width:100%;padding-top:20px;padding-bottom:50px;">
		<table align="center" class="infoTab" style="padding-bottom:50px;">
			...
			<tr>
				...
				<td colspan="2" style="text-align:right;padding-right:50px;">
					<input type="button" value="保 存 " onclick="savePbsApply('save')" style="width:50px;"/> 
					<input type="button" value="提交 " onclick="savePbsApply('sub')" style="width:50px;"/> 
				</td>
			</tr>
		</table>
		<div id="infoDiv1" >
		...
		<form id="appInfoFm" action="<%=request.getContextPath() %>/pbsApply_updApply.do" method="post">
			<table align="center" class="infoTab">
				<tr>
				...
				<tr>
					...
					<td class="input-td" >
						<select id="applyTestType" name="pbsTestApply.applyTestType" style="width:150px;">
					...
					<td class="input-td" >
						<select id="applyTestGrade" name="pbsTestApply.applyTestGrade" style="width:150px;">
							<option value="1">A级</option>
							<option value="2">B级</option>
							<option value="3">C级</option>
						</select>
						<input type="hidden" name="pbsTestApply.testApplyId" value="<%=applyId %>"/>
