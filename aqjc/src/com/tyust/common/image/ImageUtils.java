...
public class ImageUtils {
	...
	private int givenWidth;//指定的宽度
	private int givenHeight;//指定的高度
	private boolean fixedGivenSize;//是否保持原图比例
	private Color bgcolor;//生成图片的背景
	private boolean keepRatio;//是否保持比例
